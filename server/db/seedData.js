/**
 * HMS Seed Data — Populates the SQLite database on first run.
 * Data carried over from the original in-memory store so the API
 * behaves identically while now being persisted to disk.
 */

export const seedUsers = [
  { id: 'USR-001', name: 'Dr. Katherine Vance', email: 'k.vance@medicore.org', passwordHash: 'demo1234', role: 'admin', department: 'Executive Management', avatarUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=150&h=150&fit=crop&crop=face', isActive: true, createdAt: '2026-01-10T08:00:00Z' },
  { id: 'USR-002', name: 'Dr. Sarah Jenkins, MD', email: 's.jenkins@medicore.org', passwordHash: 'demo1234', role: 'doctor', department: 'Cardiology', avatarUrl: 'https://images.unsplash.com/photo-1594824813589-3549646b9762?w=150&h=150&fit=crop&crop=face', isActive: true, createdAt: '2026-01-12T08:00:00Z' },
  { id: 'USR-003', name: 'Nurse Emily Rodriguez, RN', email: 'e.rodriguez@medicore.org', passwordHash: 'demo1234', role: 'nurse', department: 'Critical Care / ICU', avatarUrl: 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?w=150&h=150&fit=crop&crop=face', isActive: true, createdAt: '2026-01-15T08:00:00Z' },
  { id: 'USR-004', name: 'Alex Morgan, MLS', email: 'a.morgan@medicore.org', passwordHash: 'demo1234', role: 'lab', department: 'Clinical Pathology', avatarUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=150&h=150&fit=crop&crop=face', isActive: true, createdAt: '2026-01-20T08:00:00Z' },
  { id: 'USR-005', name: 'Dr. David Miller, MD', email: 'd.miller@medicore.org', passwordHash: 'demo1234', role: 'radiology', department: 'Diagnostic Radiology', avatarUrl: 'https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=150&h=150&fit=crop&crop=face', isActive: true, createdAt: '2026-01-22T08:00:00Z' },
  { id: 'USR-006', name: 'Marcus Chen', email: 'm.chen@medicore.org', passwordHash: 'demo1234', role: 'reception', department: 'Patient Admissions', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face', isActive: true, createdAt: '2026-01-25T08:00:00Z' },
  { id: 'USR-007', name: 'James Wilson', email: 'j.wilson@gmail.com', passwordHash: 'demo1234', role: 'patient', department: 'Outpatient Clinic', avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face', isActive: true, createdAt: '2026-02-01T08:00:00Z' },
];
...
export const seedPatients = [
  {
    ...
    vitals: { recordedAt: '2026-09-11 08:00', bp: '128/80', systolic: 128, diastolic: 80, heartRate: 74, temperature: 98.6, tempUnit: '°F', respRate: 16, oxygenSaturation: 99, painLevel: 1, weight: '86 kg', height: '178 cm', bmi: 27.1, notes: '' },
  },
  {
    id: 'PAT-102',
    mrn: 'MC-2026-0412',
    ...
    vitals: { recordedAt: '2026-09-11 08:00', bp: '118/76', systolic: 118, diastolic: 76, heartRate: 88, temperature: 100.9, tempUnit: '°F', respRate: 22, oxygenSaturation: 94, painLevel: 3, weight: '64 kg', height: '165 cm', bmi: 23.5, notes: '' },
  },
  {
    id: 'PAT-103',
    mrn: 'MC-2026-1189',
    ...
    vitals: { recordedAt: '2026-09-11 08:00', bp: '132/82', systolic: 132, diastolic: 82, heartRate: 72, temperature: 98.2, tempUnit: '°F', respRate: 15, oxygenSaturation: 98, painLevel: 4, weight: '92 kg', height: '180 cm', bmi: 28.4, notes: '' },
  },
];

export const seedLabOrders = [
  {
    id: 'LAB-901',
    ...
    pdfReport: { fileName: 'Certified_Lab_Report_ORD-LAB-4401.pdf', fileSize: '1.4 MB', pages: 2, uploadedAt: '2026-09-10 09:14', uploadedBy: 'Alex Morgan, MLS' },
  },
  {
    id: 'LAB-902',
    ...
    pdfReport: { fileName: 'Certified_Lab_Report_ORD-LAB-4402.pdf', fileSize: '1.2 MB', pages: 2, uploadedAt: '2026-09-10 09:42', uploadedBy: 'Alex Morgan, MLS' },
  },
];

export const seedRadiologyOrders = [
  {
    id: 'RAD-501',
    ...
    pdfReport: { fileName: 'Certified_Radiology_Report_REQ-RAD-8812.pdf', fileSize: '2.8 MB', pages: 2, uploadedAt: '2026-09-08 15:50', uploadedBy: 'Dr. David Miller, MD' },
  },
];
...
export const seedInvoices = [
  {
    ...
    totalAmount: 18450.0,
    insuranceCovered: 16200.0,
    patientPayable: 2250.0,
    paidAmount: 2250.0,
    items: [
      { serviceName: 'Emergency Department Trauma Bay Intake', category: 'Emergency', quantity: 1, unitPrice: 3200.0, totalPrice: 3200.0 },
      { serviceName: 'Cardiology Telemetry Ward (3 Days)', category: 'Room & Board', quantity: 3, unitPrice: 2800.0, totalPrice: 8400.0 },
      { serviceName: 'STAT Cardiac Troponin I & CK-MB Assay', category: 'Laboratory', quantity: 2, unitPrice: 420.0, totalPrice: 840.0 },
      { serviceName: 'Chest X-Ray PA & Lateral Digital Radiograph', category: 'Radiology', quantity: 1, unitPrice: 850.0, totalPrice: 850.0 },
      { serviceName: 'Inpatient Pharmacy Infusions & Antiplatelet Meds', category: 'Pharmacy', quantity: 1, unitPrice: 1660.0, totalPrice: 1660.0 },
      { serviceName: 'Cardiologist Consultation & Telemetry Monitoring', category: 'Professional', quantity: 1, unitPrice: 3500.0, totalPrice: 3500.0 },
    ],
  },
];

export const seedVitals = [
  { id: 'VIT-001', patientId: 'PAT-101', recordedBy: 'USR-003', recordedAt: '2026-09-11 08:00', bp: '128/80', systolic: 128, diastolic: 80, heartRate: 74, temperature: 98.6, tempUnit: '°F', respRate: 16, oxygenSaturation: 99, painLevel: 1, weight: '86 kg', height: '178 cm', bmi: 27.1, notes: 'Stable. Continue telemetry monitoring.' },
  { id: 'VIT-002', patientId: 'PAT-102', recordedBy: 'USR-003', recordedAt: '2026-09-11 08:00', bp: '118/76', systolic: 118, diastolic: 76, heartRate: 88, temperature: 100.9, tempUnit: '°F', respRate: 22, oxygenSaturation: 94, painLevel: 3, weight: '64 kg', height: '165 cm', bmi: 23.5, notes: 'On 2L nasal cannula. Monitor SpO2.' },
  { id: 'VIT-003', patientId: 'PAT-103', recordedBy: 'USR-003', recordedAt: '2026-09-11 08:00', bp: '132/82', systolic: 132, diastolic: 82, heartRate: 72, temperature: 98.2, tempUnit: '°F', respRate: 15, oxygenSaturation: 98, painLevel: 4, weight: '92 kg', height: '180 cm', bmi: 28.4, notes: 'Post-op day 1. Pain controlled.' },
];
...
export const seedAll = {
  ...
  radiologyOrders: seedRadiologyOrders,
